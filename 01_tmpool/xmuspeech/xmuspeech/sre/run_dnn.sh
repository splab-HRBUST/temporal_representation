...
if [ $stage -eq 6 ]; then
  ...
  # python3.8 run_pytorch_xvector_resnet.py --stage=3 --gpu-id=3
  # python3.8 run_pytorch_xvector_resnet.py --stage=4
  # python3.8 run_pytorch_xvector_dnn.py --stage=3 --gpu-id=2
  python3.8 run_pytorch_xvector_dnn.py --stage=3

  # subtools/runPytorchLauncher.sh run_pytorch_xvector_resnet.py --gpu-id=0,1,2,3 --multi-gpu-solution="ddp"
...
if [ $stage -eq 7 ]; then
  ...
  for exp in exp/pytorch_xvector_bilstm_sap/near_epoch_21;do
