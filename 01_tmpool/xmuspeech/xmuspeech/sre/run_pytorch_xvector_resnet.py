...
report_interval_iters = 20 # About validation computation and loss reporting. If report_times_every_epoch is not None, 
...
# exist_model="exp/pytorch_xvector/9.params" 
# exist_model="exp/backup/9.params" 
# exist_model="exp/backup/21.params" 
##--------------------------------------------------##
## Main params
#traindata="data/mfcc_20_5.0/train_aug"
# traindata="data/mfcc_20_5.0/train"
traindata="data/mfcc_20_5.0/train"
# traindata="data/fbank_40_5.0/train_volume_aug"
...
# model_dir="exp/pytorch_xvector_bilstm_attentive_statistics_pooling"
# model_dir="exp/pytorch_xvector_bilstm_rank_pooling"
# model_dir = "exp/pytorch_xvector_rank_L2_1e3_tol_1e-2_wd_0_small_data"
# model_dir = "exp/pytorch_xvector_2_layers_bilstm"
# model_dir = "exp/pytorch_xvector_bilstm_stat"
# model_dir = "exp/pytorch_xvector_attentive"

# model_dir = "exp/pytorch_xvector_bilstm_multi_head"
model_dir = "exp/pytorch_xvector_transformer_mean_std_embed"
##--------------------------------------------------##
##
######################################################### START #########################################################
##
...
if stage <= 3 <= endstage:
    ...
    package = ({"data":bunch, "model":model, "optimizer":optimizer, "lr_scheduler":lr_scheduler},
            {"model_dir":model_dir, "model_blueprint":model_blueprint, "exist_model":exist_model, 
            "start_epoch":train_stage, "epochs":epochs, "use_gpu":use_gpu, "gpu_id":gpu_id, "max_change":-1,
            "benchmark":benchmark, "suffix":suffix, "report_times_every_epoch":report_times_every_epoch,
            "report_interval_iters":report_interval_iters, "record_file":"train.csv"})
...
if stage <= 4 <= endstage and utils.is_main_training():
    ...
    # prefix = "fbank_40_5.0" # For to_extracted_data.
    ...
    # to_extracted_data = ["train_volume_aug_nosil","lre07_test_3sec","lre07_test_10sec","lre07_test_30sec","lre07_enroll_volume_aug"] # All dataset should be in data_root/prefix.
    # to_extracted_data = ["lre07_test_10sec","lre07_test_30sec","lre07_enroll_volume_aug"] # All dataset should be in data_root/prefix.
    # to_extracted_data = ["lre07_test_3sec"] # All dataset should be in data_root/prefix.
    to_extracted_data = ["train_nosil", "task_1_nosil", "task_2_enroll_nosil", "task_2_nosil", "task_3_enroll_nosil", "task_3_test_nosil"]
    # to_extracted_data = ["task_2_enroll_nosil"]
