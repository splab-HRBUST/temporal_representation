...
# for x in wav.scp utt2spk spk2utt utt2lang;do
# [ ! -f $src/$x ] && echo "[exit] Expected $src/$x to exist at least." && exit 1
# done
...
# extra=
# [ "$clean" == "false" ] && extra="feats.scp vad.scp"
# for x in wav.scp utt2spk spk2utt utt2num_frames utt2dur reco2dur text utt2gender spk2gender utt2lang $extra $trials;do
# [ -f $src/$x ] && cp $src/$x $target/ && echo "[ $x ] copy done"
# done
# echo "Copy done. Your new datadir is $target."
# done
