...
class KaldiDataset():
    ...
    def get_base_attribute_(self):
        ...
        #modified for vector extraction.
        self.feat_dim = kaldi_io.read_vec_flt(self.feats_scp[list(self.feats_scp.keys())[0]]).shape[0] if "feats_scp" in self.loaded_attr else None
