...
class FusionNetXvector(TopVirtualNnet):
    ...
    def init(self, inputs_dim, num_targets, nonlinearity="relu", aug_dropout=0.2, 
                ...
                fc_params = {}, use_step = False, planes = [256]):
        ...
        if layer_num >= 1:
            self.fc1 = ReluBatchNormTdnnLayer(256*3, planes[0], **fc_params)
        else:
            self.fc1 = None
    ...
    def forward(self, inputs):
        ...
        rank_embedding = self.SimpleDnn2(point_wise_map(l2_norm(rank2_)))
