...
class ResNetXvector(TopVirtualNnet):
    ...
    def init(self, inputs_dim, num_targets, aug_dropout=0., tail_dropout=0., training=True, extracted_embedding="near", 
             resnet_params={}, pooling="stats-aug", pooling_params={}, fc1=False, fc1_params={}, fc2_params={}, margin_loss=False, margin_loss_params={},
    ...
    def forward(self, inputs):
        ...
        # print("pre resnet output = {}".format(x.shape))
