...
lda_data_config=""  # if NULL, will be set "$enrollset[$enrollset $testset]"
...
submean_data_config="" # if NULL, will be set "$enrollset[$enrollset $testset]"
...
whiten_data_config="" # if NULL, will be set "$enrollset[$enrollset $testset]"
...
# lr_process="submean-whiten-norm"
...
echo "--------------$testset----------------------"
echo "--------------$enrollset----------------------"
echo "$trainset[$trainset $enrollset $testset]"
...
echo "--------------lda_data_config=$lda_data_config------------"
