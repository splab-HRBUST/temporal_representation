...
class LanguageClassificationDataSample:
...
@dataclasses.dataclass
class LanguageClassificationDataBatch:
    ...
    def to(self, device: torch.device) -> "LanguageClassificationDataBatch":
        return LanguageClassificationDataBatch(
            self.batch_size,
            self.keys,
    ...
    def default_collate_fn(
        lst: List[LanguageClassificationDataSample],
...
@dataclasses.dataclass
class PairedLanguageClassificationDataSample:
...
@dataclasses.dataclass
class PairedLanguageClassificationDataBatch:
    # the number of samples this batch contains
    batch_size: int
    ...
    def to(self, device: torch.device) -> "PairedLanguageClassificationDataBatch":
        return PairedLanguageClassificationDataBatch(
            self.batch_size,
            self.primary_keys,
            self.secondary_keys,
    ...
    @staticmethod
    def default_collate_fn(
        lst: List[PairedLanguageClassificationDataSample],
