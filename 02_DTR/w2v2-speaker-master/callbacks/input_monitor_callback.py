...
class InputMonitor(Callback):
    supported_batches = [SpeakerClassificationDataBatch,LanguageClassificationDataBatch]
...
def debug_log_batch(
    batch: Union[SpeakerClassificationDataBatch,LanguageClassificationDataBatch],
